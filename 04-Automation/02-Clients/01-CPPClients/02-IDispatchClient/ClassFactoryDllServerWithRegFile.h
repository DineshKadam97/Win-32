...
// why separate eturn 0 and return m_cRef object delete zalyanantr return kaay karnar, tyamule return 0;
// pUnkOuter what is this??
// what is the third parameter of CoGetClassObject?, COSERVERINFO structure cha pointer aahe
