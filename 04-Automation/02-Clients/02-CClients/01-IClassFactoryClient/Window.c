...
#include "Window.h"
#include "AutomationServerHeaderForCClient.h" //Change 1 : Now including C syntax automation server header file
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch (iMsg)
	{
		case WM_CREATE: //Change 2 : we pass reference to CLSID and IID to CoCreateInstance
			...
			//Now you can not call functions directly you must call them upon lpVtbl  
