...
//CONTAINMENT => CLASS FACTORY + OTHER THINGS

//AGGREGATION => CLASS FACTORY + OTHER THINGS (DIFFERENT WAY OF DOING CONTAINMENT)

//MADHLA C  => Middleware(madhyasti), Container(Binary encapsulate karto inner la from client), Load Balancer
